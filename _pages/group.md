...
<ul>
    <li>Sarah Li (2024&2025 Summer ASSIP, McLean High School; <a href="https://journals.gmu.edu/jssr/article/view/4358">abstract: GenAI Agents on Web Tasks</a>; :trophy: at <a href="https://www.fcps.edu/2025-science-fair-category-awards">Fairfax 2025 Science Fair</a>; Paper at IEEE ICDM 2025 Undergraduate and High School Symposium)</li>
...
<div class="row justify-content-center">
    <div class="col-md-6 align-items-center">
        {% include figure.html path="assets/img/Spring26-semester-grad-celebrate1.jpg" title="Spring26 celebration" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-md-6 align-items-center">
        {% include figure.html path="assets/img/Spring26-semester-grad-celebrate2.jpg" title="Spring26 celebration" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">Celebrating end of semester (Spring'26) and Saurabh's expected graduation.</div>
...
<div class="container text-center">
  <div class="row justify-content-center mb-3">
    ...
    <div class="col-md-4 align-items-center">
      {% include figure.html path="assets/img/GMU-new.png" title="GMU" class="img-fluid rounded z-depth-1" caption="GMU Grand Challenge Initiative. Role: Co-PI, 07/2026-12/2027. w/ Jennifer Suh, Thema Monroe‑White, and Jered Borup (GMU)" url="https://www.gmu.edu/grandchallenge" %}
    </div>
    <div class="col-md-4 align-items-center">
    ...
    <div class="col-md-4 align-items-center">
      {% include figure.html path="assets/img/amazon.png" title="Amazon" class="img-fluid rounded z-depth-1" caption="AWS Trainium Credits for Responsible AI. Role: PI, 05/2026-." %}
    </div>
    <div class="col-md-4 align-items-center">
    ...
    <div class="col-md-4 align-items-center">
      {% include figure.html path="assets/img/gmu.jpeg" title="GMU" class="img-fluid rounded z-depth-1" caption="PatriBot Project from GMUF/GMUIF. Role: Co-PI, 05/2024-08/2026. w/ Sarah Campbell, Amarda Shehu, and Marcos Zampieri (GMU)" %}
    </div>
    <div class="col-md-4 align-items-center">
